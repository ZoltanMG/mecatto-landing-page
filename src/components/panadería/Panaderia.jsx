...
import panaderiaImage from '../../assets/images/panaderia.png'
...
function Panaderia() {
  ...
  return (
    <div id='panaderia'>
      <div className="parallax-container-panaderia" style={{
        backgroundImage: `url(${panaderiaImage})`,
        backgroundPosition: `center ${-850 + offsetY * 0.4}px`,
      }}>
